...
#ifndef __KERNEL_EPUBKIT_EPUBLIB_EXPORT_DKEERROR_H__
#define __KERNEL_EPUBKIT_EPUBLIB_EXPORT_DKEERROR_H__
...
// Patch错误返回至
#define DKR_EPUB_PATCH_NOT_ENOUGH_TO_UPDATE              (DKR_EPUB_CONTAINER_BASEVALUE + 29L)
#define DKR_EPUB_PATCH_UPDATE_FAIL                       (DKR_EPUB_CONTAINER_BASEVALUE + 30L)

#define DKR_EPUB_FONTENGINE_CREATE_ERR                   (DKR_EPUB_CONTAINER_BASEVALUE + 40L)
...
#define DKR_EPUB_PARSER_PAGEBREAKFILE_ENV_ERR           (DKR_EPUB_PARSER_BASEVALUE + 31L)
#define DKR_EPUB_PARSER_PAGEBREAKFILE_FLOWPOSITION_ERR           (DKR_EPUB_PARSER_BASEVALUE + 32L)
...
#endif // #ifndef __DKEERROR_HEADERFILE__
