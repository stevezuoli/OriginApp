...
public:
    ...
    void AddRelatedBook(BookInfoSPtr bookInfo)
    {
        m_relatedBooks.push_back(bookInfo);
    }

    void SetSubType(ObjectType subType)
    {
        m_subType = subType;
    }
    ...
    std::string GetEditors() const
    {
        return m_editors;
    }

    std::string GetTranslators() const
    {
    ...
    int GetDiscountPrice() const
    {
        return m_discountPrice;
    }

    int GetPaperPrice() const
    {
        return m_paperPrice;
    }
    ...
    std::string& MutableFileUrl()
    {
        return m_fileUrl;
    }

    std::string GetTrialUrl() const
    {
        return m_trialUrl;
    }

    std::string GetCopyRights() const
    {
        return m_rights;
    }
    ...
    std::string& MutableRevision()
    {
        return m_revision;
    }

    std::string GetIap() const
    {
        return m_iap;
    }
    ...
    std::string GetLowestKernelVersion() const
    {
        return m_lowestKernelVersion;
    }

    const BookInfoList& GetRelatedBooks() const
    {
        return m_relatedBooks;
    }

    //CatalogueInfoList GetCatalogueList()
    const CatalogueInfoList& GetCatalogueList() const
    {
        return m_catalogueLst;
    }
    ...
    std::string GetIssuedTime() const
    {
        return m_issuedTime;
    }
    ...
    std::string& MutableOrderId()
    {
        return m_orderId;
    }

	int GetPurchasedUTCTime() const
	{
		return m_PurchasedUTCtime;
	}
