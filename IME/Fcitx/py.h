...
typedef struct PYBASE {
    ...
    unsigned long            iHit;
    unsigned long            flag:1;
    unsigned long        iChangeCount;    //Whether we have changed the Index/Hit value of this group
} PyBase;
...
typedef struct PYCANDWORD {
    PCand           cand;
    unsigned long            iWhich:3;    //0->Auto 1->System single HZ 2->System phrase 3->User phrase 4->frequent HZ
} PYCandWord;
