...
#ifdef _USE_XFT
int StringWidth (const char *str, XftFont * font)
{
...
#else
int StringWidth (const char *str, XFontSet font)
//int StringWidth (char *str, void* font)
{
    return 0;
#if 0
