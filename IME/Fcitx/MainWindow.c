...
WINDOW_COLOR    mainWindowColor = { 0, 0, {0, 240 << 8, 255 << 8, 240 << 8} };
MESSAGE_COLOR   mainWindowLineColor = { 0, {0, 150 << 8, 220 << 8, 150 << 8} }; //线条色
MESSAGE_COLOR   IMNameColor[3] = {  //输入法名称的颜色
    {0, {0, 170 << 8, 170 << 8, 170 << 8}},
    {0, {0, 150 << 8, 200 << 8, 150 << 8}},
    {0, {0, 0, 0, 255 << 8}}
};
