...
unsigned long uQuickPhraseCount;
...
//szj    strcpy (strPath, (char *) getenv ("HOME"));
//szj    strcat (strPath, "/.fcitx/");
//szj    strcat (strPath, "QuickPhrase.mb");
...
//szj INPUT_RETURN_VALUE QuickPhraseDoInput (int iKey)
int  QuickPhraseDoInput (int iKey)
{
    int retVal;
...
//szj INPUT_RETURN_VALUE QuickPhraseGetCandWords (SEARCH_MODE mode)
int   QuickPhraseGetCandWords (SEARCH_MODE mode)
{
    int i, iInputLen;
    char strTemp[2];
